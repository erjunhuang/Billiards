...
function BilliardsBallData:initColorDatas()
    ...
    for typeIndex = 0, self.__ballCount - 1, 1 do
        ...
        -- print("outColor32Array = > ", outColor32Array)

        self:__calcColorData(typeIndex, outColor32Array, inColor32Array, bWidth, bHeight, numColor32Array, numWidth, numHeight)

        self.__colorDatasTable[typeIndex] = outColor32Array
    end
end
...
function BilliardsBallData:__calcColor32(color32Array, colorIndex, uintColor)
...
function BilliardsBallData:__calcColorData(typeIndex, outColor32Array, inColor32Array, bWidth, bHeight, numColor32Array, numWidth, numHeight)
    local xIndex = 0
    local yIndex = 0
    if typeIndex == 0 then
        -- 母球
        while yIndex < bHeight do
            ...
            while xIndex < bWidth do
                ...
                self:__calcColor32(outColor32Array, colorIndex, color)
                xIndex = xIndex + 1
            end
            yIndex = yIndex + 1
        end
        ...
        while yIndex < bHeight do
            ...
            while xIndex < bWidth do
                ...
                self:__calcColor32(outColor32Array, colorIndex, outColor)
        ...
        while yIndex < numWidth do
            ...
            while xIndex < numWidth do
                ...
                local color32 = outColor32Array[colorIndex]
